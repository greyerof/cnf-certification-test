...
TNF_OMIT_ARTIFACTS_FILE_DEFAULT=false
...
TNF_OMIT_ARTIFACTS_FILE="${TNF_OMIT_ARTIFACTS_FILE:-$TNF_OMIT_ARTIFACTS_FILE_DEFAULT}"
display_config_summary
...
${TNF_CONTAINER_CLIENT} run --rm $DNS_ARG \
	...
	-e TNF_OMIT_ARTIFACTS_FILE=$TNF_OMIT_ARTIFACTS_FILE \
